...
11. press O to toggle light 1
12. press L to toggle light 2
13. scroll up (mousewheel) to move camera away from scene
14. scroll down to move camera towards scene
15. press P to pause or unpause simulation

Although i could not get force visualization to work, i have left the code in the source file.
